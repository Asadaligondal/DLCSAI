export const ACCOMMODATIONS_MASTER = {
  ...
  scheduling: [
    { id: 'allow_extended_time', label: 'Allow extended time', subOptions: [
        { id: 'ext_time_25', label: '25% extra time' },
        { id: 'ext_time_50', label: '50% extra time' },
        { id: 'ext_time_75', label: '75% extra time' },
        { id: 'ext_time_100', label: '100% extra time (double time)' },
        { id: 'ext_time_unlimited', label: 'Unlimited time' }
      ] },
